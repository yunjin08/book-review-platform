...
export default function SignupPage() {
  return (
    <div className="flex flex-col bg-white text-black items-center justify-center min-h-screen p-4">
      <div className="w-full max-w-md px-4 md:px-8 py-16 bg-slate-800 rounded-lg shadow-lg">
