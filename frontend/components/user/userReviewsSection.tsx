...
const reviews: BookReview[] = [
  {
    ...
    rating: 5,
    review:
      "Fitzgerald paints a vivid picture of jazz-age decadence and the illusions we chase. This book lingers long after the last page.",
    coverUrl: "/logo.png",
  },
  {
    ...
    rating: 5,
    review:
      "A deeply moving exploration of racial injustice told through the innocent perspective of Scout. A must-read for empathy and understanding.",
    coverUrl: "/logo.png",
  },
  {
    bookTitle: "1984",
    ...
    rating: 4,
    review:
      "Chilling and eerily prescient. Orwell’s vision of surveillance and control is more relevant than ever.",
    coverUrl: "/logo.png",
  },
  {
    ...
    rating: 5,
    review:
      "Elizabeth Bennet is one of literature’s sharpest heroines. Austen’s social critique is both biting and beautiful.",
    coverUrl: "/logo.png",
  },
  {
    bookTitle: "Moby Dick",
    ...
    rating: 3,
    review:
      "Epic and ambitious, but bogged down in detail. Worth the voyage if you can weather the long winds.",
    coverUrl: "/logo.png",
  },
  {
  ...
  return (
    <div className="flex flex-col w-full text-black px-3 md:px-24 xl:px-72 pt-4 md:pt-8 pb-8 md:pb-16">
      ...
      <p className="text-xs md:text-lg text-justify mb-4">
        Take a look back on what you have said about the books you have read.
        Maybe the creative inspiration you need to read again is not another
        book, but your own stroke of genius (or <i>profound</i> lack thereof).
      </p>
